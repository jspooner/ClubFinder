...
- (void) encodeWithCoder:(NSCoder *)encoder
{
    ...
    [encoder encodeObject:self.lastLocation forKey:@"lastLocation"];
    [encoder encodeObject:self.lastLocationTimestamp forKey:@"lastLocationTimestamp"];
}
...
- (id)initWithCoder:(NSCoder *)decoder
{
    ...
    self.lastLocationTimestamp = [decoder decodeObjectForKey:@"lastLocationTimestamp"];
