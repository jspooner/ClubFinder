...
//                                              [NSString stringWithUTF8String:"\xC2\xB0 F" ]];
            if (transmitter.lastLocation != nil) {
                sightingsCell.temperature.text = [NSString stringWithFormat:@"%.2f, %.2f", transmitter.lastLocation.coordinate.latitude, transmitter.lastLocation.coordinate.longitude];
            }
...
{
    return [[self.beaconManager transmittersInBag] count];
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    Transmitter *transmitter = [[self.beaconManager transmittersInBag] objectAtIndex:indexPath.row];
    if (cell == nil) {
